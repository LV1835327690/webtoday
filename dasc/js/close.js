...
$(function(){
		...
		var timer=null;
		$("#next").click(function(){
		$("#second-floor").animate({
			"left":"-180px"
		},function(){
			$("#second-floor").find("dl").eq(0).appendTo($("#second-floor"))
			$("#second-floor").css("left",0)
			})
		})	
		//点击左边按钮
		$("#prev").click(function(){
			$("#second-floor").find('dl:last').prependTo($("#second-floor"))
			$("#second-floor").css("left","-180px")
			$("#second-floor").animate({
				"left":0
			})
		})
